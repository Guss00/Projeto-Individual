...
function cadastrar(req, res) {
    ...
    var genero2 = req.body.genero2Server;
    var genero3 = req.body.genero3Server;
    ...
    if (nome == undefined) {
        ...
        res.status(400).send("O segundo genero está undefined!");
    } else if (genero3 == undefined){
        res.status(400).send("O terceiro genero está undefined!");
    } else {
        
        // Passe os valores como parâmetro e vá para o arquivo usuarioModel.js
        usuarioModel.cadastrar(nome, email, senha, genero1, genero2, genero3)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
